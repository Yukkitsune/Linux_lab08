...
# -*- rpm-spec -*-
BuildRoot:      %_topdir/bank_lib-1.14.0-Linux
...
%define _rpmfilename bank_lib-1.14.0-Linux.rpm
...
%changelog
* Sun Jun 02 2024 Yukkitsune <akito.merkulov@ya.ru> 0.1.0.0
- Initial RPM release
